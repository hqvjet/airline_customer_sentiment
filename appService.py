...
def getRatingFromModel(title, content, model_name, emb_tech):
    ...
    if emb_tech == GLOVE_METHOD:
        if model_name == CNN_MODEL:
            ...
            y_pred = glove_ensemble_lstm.predict(input)
