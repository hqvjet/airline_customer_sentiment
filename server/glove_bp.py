...
def using_ensemble_cnn_bilstm():
    ...
    res = getRatingFromModel(title, content, ENSEMBLE_CNN_BILSTM_MODEL, GLOVE_METHOD).tolist()
...
def using_ensemble_cnn_bigru():
    ...
    res = getRatingFromModel(title, content, ENSEMBLE_CNN_BIGRU_MODEL, GLOVE_METHOD).tolist()
...
def using_fusion_cnn_bilstm():
    ...
    res = getRatingFromModel(title, content, FUSION_CNN_BILSTM_MODEL, GLOVE_METHOD).tolist()
...
def using_fusion_cnn_bigru():
    ...
    res = getRatingFromModel(title, content, FUSION_CNN_BIGRU_MODEL, GLOVE_METHOD).tolist()
